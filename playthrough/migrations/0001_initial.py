# Generated by Django 3.0.4 on 2020-07-18 18:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, help_text="The Series' name.", max_length=255, unique=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(help_text='The role to grant upon game completion.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='game', to='playthrough.RoleTemplate'),
        ),
        migrations.AddField(
            model_name='game',
            name='prequels',
            field=models.ManyToManyField(blank=True, help_text="The game's prequels.", related_name='sequels', to='playthrough.Game'),
        ),
        migrations.AddField(
            model_name='game',
            name='series',
        ...
        migrations.AddField(
            model_name='category',
            name='guild',
            field=models.ForeignKey(help_text="The Category's Guild.", on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='playthrough.Guild'),
        ),
        migrations.CreateModel(
            name='Archive',
            fields=[
